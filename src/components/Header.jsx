	...
	return (
		<div className='fixed top-0 left-0 w-full z-50 bg-n-8/90 backdrop-blur-sm border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm'>
			<div className='items-center flex px-5 lg:px-7.5 xl:px-10 max-lg:py-4'>
				...
				<nav className='hidden fixed top-[5rem] left-0 right-0 button-0 bg-n-8 lg:static lg:flex lg:mx-auto lg:bg-transparent'>
						...
						{navigation.map((item) => (
							<a
								...
								className={`block relative text-2xl
                                 hover:text-color-1 text-n-1 font-code uppercase transition-colors ${
